                                    ...
                                    <div class="step-tab-panel active" id="steppanel1">
                                        <div class="general-sec">
                                            <form action="" method="post">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h5 class="text-light-black fw-700">Thông tin chung</h5>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Tên nhà hàng<sup class="fs-16">*</sup>
                                                            </label>
                                                            <input type="text" name="restaurantName" class="form-control form-control-submit" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Số ĐT nhà hàng</label>
                                                            <input type="text" name="restaurantPhone" class="form-control form-control-submit" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Tên người quản lý</label>
                                                            <input type="text" name="restaurantManager" class="form-control form-control-submit" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Số ĐT người quản lý</label>
                                                            <input type="text" name="restaurantPhoneManager" class="form-control form-control-submit" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Email liên lạc</label>
                                                            <input type="email" name="restaurantEmail" class="form-control form-control-submit" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h5 class="text-light-black fw-700">Vị trí</h5>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Thành Phố</label>
                                                            <input type="text" name="RestaurantCity" class="form-control form-control-submit" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Quận/Huyện</label>
                                                            <input type="text" name="RestaurantDistrict" class="form-control form-control-submit" required> 
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label class="text-light-black fw-700">Địa chỉ cụ thể <sup class="fs-16"></sup>
                                                            </label>
                                                            <input type="text" name="RestaurantAddress" class="form-control form-control-submit" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- <div class="row">
                                                ...
                                                <div class="row">
                                                    <button type="submit" class="btn-second btn-submit full-width">Tạo nhà hàng</button>
                                                    <!-- <div class="col-md-12">
                                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="package-box main-box">
                                                        <div class="package-img">
                                                            <a href="#">
                                                                <img src="assets/img/package/package-1.jpg" class="img-fluid full-width" alt="package image">
                                                            </a>
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="package-box main-box">
                                                        <div class="package-img">
                                                            <a href="#">
                                                                <img src="assets/img/package/package-2.jpg" class="img-fluid full-width" alt="package image">
                                                            </a>
                                                        </div>
                                                        <div class="package-caption padding-20 bg-black">
                                                            <div class="package-item-first">
