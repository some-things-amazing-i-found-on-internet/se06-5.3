      ...
      <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="ms-card">
              <div class="ms-card-img">
                <img src="<?php echo $prefixPath ?>assets/img/costic/food-6.jpg" alt="card_img">
              </div>
              <div class="ms-card-body">
                <div class="new">
                  <h6 class="mb-0">Veggies </h6>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="ms-card">
              <div class="ms-card-img">
                <img src="<?php echo $prefixPath ?>assets/img/costic/food-7.jpg" alt="card_img">
              </div>
              <div class="ms-card-body">
                <div class="new">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="ms-card">
              <div class="ms-card-img">
                <img src="<?php echo $prefixPath ?>assets/img/costic/food-8.jpg" alt="card_img">
              </div>
              <div class="ms-card-body">
                <div class="new">
