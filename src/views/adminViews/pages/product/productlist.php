        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-img">
              <img style="width: 1000px; height: 170px;" src=<?php echo $row['photos'] ?> alt="card_img">
            </div>
            <div class="ms-card-body">
              <div class="new">
                <h6 class="mb-0"><?php echo $row['name'] ?> </h6>
                <h6 class="ms-text-primary mb-0"><?php echo number_format($row['price_value']) . $row['price_unit'] ?></h6>
              </div>
              <p><?php echo "Mô tả: " . $row['description'] ?></p>
              <div class="new mb-0">
