            ...
            <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
                ...
                <li class="ms-nav-item ms-nav-user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="media fs-14 p-2" href="<?php echo $prefixPath ?>pages/prebuilt-<?php echo $prefixPath ?>pages/default-login.html"> <span><i class="flaticon-shut-down mr-2"></i> Logout</span>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <div class="ms-quickbar-container ms-scrollable">
                        ...
                        <div class="ms-card ms-qa-card ms-deletable">
                            ...
                            <div class="ms-card-body">
                                ...
                                <ul class="ms-note-members clearfix mb-0">
                                    <li class="ms-deletable"> <img src="<?php echo $prefixPath ?>assets/img/people/people-3.jpg" alt="member"> </li>
                                    <li class="ms-deletable"> <img src="<?php echo $prefixPath ?>assets/img/people/people-5.jpg" alt="member"> </li>
                                </ul>
                            </div>
                            <div class="ms-card-footer clearfix">
                                        ...
                                        <li class="ms-scrollable ms-dropdown-list ms-members-list">
                                            <a class="media p-2" href="#">
                                                <div class="mr-2 align-self-center">
                                                    <img src="<?php echo $prefixPath ?>assets/img/people/people-10.jpg" class="ms-img-round" alt="people">
                                                </div>
                                            ...
                                            <a class="media p-2" href="#">
                                                <div class="mr-2 align-self-center">
                                                    <img src="<?php echo $prefixPath ?>assets/img/people/people-9.jpg" class="ms-img-round" alt="people">
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <a class="media p-2" href="#">
                                                <div class="mr-2 align-self-center">
                                                    <img src="<?php echo $prefixPath ?>assets/img/people/people-7.jpg" class="ms-img-round" alt="people">
                                                </div>
                                                <div class="media-body">
                        ...
                        <div class="ms-card ms-qa-card ms-deletable">
                            ...
                            <div class="ms-card-body">
                                ...
                                <ul class="ms-note-members clearfix mb-0">
                                    <li class="ms-deletable"> <img src="<?php echo $prefixPath ?>assets/img/people/people-9.jpg" alt="member"> </li>
                                </ul>
                            </div>
                            <div class="ms-card-footer clearfix">
